...
//         if ($fadeIn || $fadeOut || $reverse) {
//             $command .= $this->addAudioFilters($escapedSourceFile, $fadeIn, $fadeOut, $reverse);
//         }
...
//     protected function addAudioFilters(string $filePath, bool $fadeIn, bool $fadeOut, bool $reverse): string
//     {
//         $audioFilters = "";
