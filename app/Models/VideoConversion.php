...
class VideoConversion extends Model
{
    ...
    protected $fillable = ['original_name', 'original_format', 'converted_format', 'status', 'guid', 'converted_name', 'file_size', 'width', 'height', 'frame_rate', 'rotation_angle', 'flip', 'audio'];
