            ...
            <div class="col-md-3 col-lg-3 col-sm-12">
                <div class="package">
                    <div class="package2">
                      ...
                      <p class="text-light pt-2">We delete all files after 7 days to give you time to redownload your files, however there is always the option to delete your files immediately earlier <router-link to="/previousconversions" class="text-light">click here</router-link> to do so</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-12">
